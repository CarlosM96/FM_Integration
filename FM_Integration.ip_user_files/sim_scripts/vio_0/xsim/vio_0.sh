...
#
# Generated by Vivado on Tue Jul 12 14:48:24 +0200 2022
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot vio_0 xil_defaultlib.vio_0 xil_defaultlib.glbl -log elaborate.log
}
