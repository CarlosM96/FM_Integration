...
#
# Generated by export_simulation on Tue Jul 12 14:36:34 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './felix_gtp0.sh' script.

./felix_gtp0.sh -reset_run
...
./felix_gtp0.sh -noclean_files

For more information on the script, please type './felix_gtp0.sh -help'.
