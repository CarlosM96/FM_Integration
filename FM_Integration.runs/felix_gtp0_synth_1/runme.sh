...
HD_PWD='C:/Users/HP/Documents/DUNE at CERN/FM_Integration/FM_Integration.runs/felix_gtp0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log felix_gtp0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source felix_gtp0.tcl
